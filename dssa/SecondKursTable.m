...
//
#import "SecondKursTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface SecondKursTable ()

@end

@implementation SecondKursTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"SecondKurs" ofType:@"xml"];
