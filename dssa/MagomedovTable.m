...
#import "MagomedovTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface MagomedovTable ()

@end

@implementation MagomedovTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Magomedov" ofType:@"xml"];
