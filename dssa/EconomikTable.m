...
#import "EconomikTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface EconomikTable ()
@end

@implementation EconomikTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Economi4eskayaTeoriya" ofType:@"xml"];
