...
#import "AtagishievaTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface AtagishievaTable ()

@end

@implementation AtagishievaTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Atagishieva" ofType:@"xml"];
