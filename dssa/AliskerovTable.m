...
#import "AliskerovTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface AliskerovTable ()

@end

@implementation AliskerovTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Aliskerov" ofType:@"xml"];
