...
#import "BuhgalterTable.h"
#import "DocCell.h"
#import "ViewController.h"
@interface BuhgalterTable ()
@end

@implementation BuhgalterTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"buhgalter" ofType:@"xml"];
