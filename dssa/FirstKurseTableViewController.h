//
//  FirstKurseTableViewController.h
//  dssa
//
...
@interface FirstKurseTableViewController : UITableViewController <NSXMLParserDelegate , UIAlertViewDelegate , UITableViewDataSource, UITableViewDelegate>
