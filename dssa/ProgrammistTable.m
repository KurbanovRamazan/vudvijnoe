...
#import "ProgrammistTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface ProgrammistTable ()
@end

@implementation ProgrammistTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"programis" ofType:@"xml"];
