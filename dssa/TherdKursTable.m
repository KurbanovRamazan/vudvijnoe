...
#import "TherdKursTable.h"
#import "DocCell.h"
#import "ViewController.h"
@interface TherdKursTable ()
@end

@implementation TherdKursTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"TherdKurs" ofType:@"xml"];
