//
//  SpecialnostTableViewController.h
//  dssa
//
...
@interface SpecialnostTableViewController : UITableViewController <NSXMLParserDelegate ,UIAlertViewDelegate, UISearchBarDelegate , UITableViewDataSource, UITableViewDelegate>
