...
#import "DaytibekovnaTable.h"
#import "DocCell.h"
#import "ViewController.h"

@interface DaytibekovnaTable ()

@end

@implementation DaytibekovnaTable
...
- (void)viewDidLoad
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"Daytibekovna" ofType:@"xml"];
